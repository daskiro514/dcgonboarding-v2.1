...
const PartnerAdminDashboard = ({ getPartnerTransactions, partnerID, transactions }) => {
  React.useEffect(() => {
...
export default connect(mapStateToProps, { getPartnerTransactions })(PartnerAdminDashboard)