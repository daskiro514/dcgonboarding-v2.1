          ...
          <div className="col-md-8">
            ...
            {customerProduct.type === 'Subscription Product' ?
              <h4 className="w3-justify" style={{ margin: "0px 20px" }}>
                Thank you <span className="w3-text-light-green">{customer.name}</span>. We have received your product request. Your purchased product is <span className="w3-text-light-green">{customerProduct.name}</span>. And the price is <span className="w3-text-light-green">{customerProduct.price / 100}$ / {customerProduct.recurringInterval}</span>. Your username is <span className="w3-text-light-green">{customer.username}</span> and password is <span className="w3-text-light-green">{customer.passwordForUpdate}</span>. You can login from now on. Thank you. <br /><br />DCGONBOARDING Team.
              </h4> :
              <h4 className="w3-justify" style={{ margin: "0px 20px" }}>
                Thank you <span className="w3-text-light-green">{customer.name}</span>. We have received your product request. Your purchased product is <span className="w3-text-light-green">{customerProduct.name}</span>. And the price is <span className="w3-text-light-green">{customerProduct.price / 100}$</span>. Thank you. <br /><br />DCGONBOARDING Team.
              </h4>
            }
